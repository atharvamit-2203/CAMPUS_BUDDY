                    ...
                    <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 border border-blue-500/50 rounded-3xl p-6 backdrop-blur-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-white">50,324</p>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 bg-gray-700/30 rounded-xl">
                                <div>
                                    ...
                                    <p className="text-gray-400 text-sm">25,487 active accounts</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-700/30 rounded-xl">
                                <div>
                                    ...
                                    <p className="text-gray-400 text-sm">12,356 active accounts</p>
                                </div>
